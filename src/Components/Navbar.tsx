...
export default function Header(){
  ...
  const logoutWithGoogle = async()=> {
    ...
    return(<><nav className="navbar justify-content-center" style={{backgroundColor:"#487E6E",height:"4.3rem"}} data-bs-theme="dark">
      ...
      <button style={{backgroundColor:"#edb077",borderRadius:"5px",padding:"2px 10px",margin:"1px 1px", fontWeight:"300", fontSize:"20.5px", border:"none",height:"2.6rem"}} className="nav-link navbar-brand text-light" onClick={()=>logoutWithGoogle()}>Logout</button>
      </nav></>)
}