...
export function StudentPassportAndVisaDetails({
  ...
  updateFields
   ...
   <FormWrapper title={otherNames?`${otherNames}'s | PASSPORT AND VISA DETAILS`:"APPLICATION | PASSPORT AND VISA DETAILS"}>
    ...
    <Form.Group>
      <Form.Label>Nationality (As per your passport):<span style={{color:"red"}}>*</span></Form.Label>
      <Form.Control as="select" name="nationality" value={nationality} onChange={e=> updateFields({nationality:e.target.value.toLowerCase()})} autoFocus required>
  ...
  <option value="zimbabwean">Zimbabwean</option>
    ...
    <Form.Group>
      <Form.Label>Country of Birth:<span style={{color:"red"}}>*</span></Form.Label>
    ...
    <Form.Group>
      <Form.Label>Passport Issue Date:<span style={{color:"red"}}>*</span></Form.Label>
    ...
    <Form.Group>
      <Form.Label>Passport Expiry Date:<span style={{color:"red"}}>*</span></Form.Label>
    ...
    <Form.Group>
      <Form.Label>Have you previously visited or studied in Australia?<span style={{color:"red"}}>*</span></Form.Label>
      <div>
    ...
    <Form.Group>
      <Form.Label>Do you currently hold an Australian Visa?<span style={{color:"red"}}>*</span></Form.Label>
      <div>
        ...
        <Form.Check inline label="No" type="radio" name="holdingAusVisa" value="no" checked={holdingAusVisa === 'no'} onChange={e=> updateFields({holdingAusVisa:e.target.value,holdingAusVisaGrantNumber:""})}/>
      </div>
    </Form.Group>

    <Form.Group>
      <Form.Label>If yes, Visa Grant Number:</Form.Label>
      <Form.Control type="text" name="holdingAusVisaGrantNumber" maxLength={13} value={holdingAusVisa == 'yes'?holdingAusVisaGrantNumber:""} onChange={e=> updateFields({holdingAusVisaGrantNumber:e.target.value.trim()})} disabled={holdingAusVisa == 'yes'?false:true}/>
    </Form.Group>

    <Form.Group>
      <Form.Label>Have you had any previous Visa condition breaches?<span style={{color:"red"}}>*</span></Form.Label>
      <div>
    ...
    <Form.Group>
      <Form.Label>Have you ever been refused a Visa for entry, had your visa cancelled, or overstayed your visa in Australia or another country?<span style={{color:"red"}}>*</span></Form.Label>
      <div>
    ...
    <Form.Group>
      <Form.Label>Have you ever applied and/or received a protection visa in any country to date?<span style={{color:"red"}}>*</span></Form.Label>
      <div>
    ...
    <Form.Group>
      <Form.Label>Have you ever been convicted of a criminal offence?<span style={{color:"red"}}>*</span></Form.Label>
      <div>
