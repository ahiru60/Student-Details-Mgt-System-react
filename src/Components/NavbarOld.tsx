...
//console.log(userContext.user)
  ...
  <Nav.Item>
  {windowSize[0]> 500 &&<Nav.Link className="navbar navbar-brand text-light " style={{margin:"2px 5px"}} onClick={()=>{navigate("/dashboard")}}>THIS WEBSITE NAME</Nav.Link>}
  </Nav.Item>
    <Nav.Item className="table-hover">
    <Nav.Link style={{color:"white",fontSize:"17.5px", fontWeight:"200"}} onClick={()=>{navigate("/dashboard")}} hidden={userContext.user == null? true : false} >Dashboard</Nav.Link>
  </Nav.Item>
  <Nav.Item>
