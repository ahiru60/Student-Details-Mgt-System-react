...
export function MainStudentDetails({
    ...
    const[haveMID,setHaveMID] = useState(false)
    ...
    return (
        ...
        <Form.Group className="mb-3">
                ...
                <Form.Control type="text" name="monash-Id"  value={monashIdCheck=="yes"?monashId:""} onChange={e=> updateFields({monashId:monashIdCheck=="yes"?e.target.value.trim():""})} disabled={monashIdCheck=="yes"?false:true}/>
            </Form.Group>
            <Form.Group>
            ...
            <h4>1st University Applying For:<span style={{color:"red"}}>*</span></h4><Form.Group>
            ...
            <Form.Group>
                <Form.Label>Preference 1 (Programme Code & Programme Name):<span style={{color:"red"}}>*</span></Form.Label>
                ...
                <Form.Control type="text" name="1stUniProgram-preference-2" value={firstUniProgramPreferenceTwo} onChange={e=> updateFields({firstUniProgramPreferenceTwo:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Preference 3 (Programme Code & Programme Name):</Form.Label>
                <Form.Control type="text" name="1stUniProgram-preference-3" value={firstUniProgramPreferenceThree} onChange={e=> updateFields({firstUniProgramPreferenceThree:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Intake:</Form.Label>
                <Form.Control type="text" name="intake" value={intake} onChange={e=> updateFields({intake:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Campus (Location):</Form.Label>
                <Form.Control type="text" name="campus" value={campus} onChange={e=> updateFields({campus:e.target.value})}/>
                <br /></Form.Group><h4>2nd University Applying For:</h4><Form.Group>
                <Form.Control type="text" name="university-preference-2" value={universityPreferenceTwo} onChange={e=> updateFields({universityPreferenceTwo:e.target.value})}/>
                ...
                <Form.Control type="text" name="2ndUniProgram-preference-1" value={secondUniProgramPreferenceOne} onChange={e=> updateFields({secondUniProgramPreferenceOne:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Preference 2 (Programme Code & Programme Name):</Form.Label>
                <Form.Control type="text" name="2ndUniProgram-preference-2" value={secondUniProgramPreferenceTwo} onChange={e=> updateFields({secondUniProgramPreferenceTwo:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Preference 3 (Programme Code & Programme Name):</Form.Label>
                <Form.Control type="text" name="2ndUniProgram-preference-3" value={secondUniProgramPreferenceThree} onChange={e=> updateFields({secondUniProgramPreferenceThree:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Intake:</Form.Label>
                <Form.Control type="text" name="intake" value={secondUniintake} onChange={e=> updateFields({secondUniintake:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Campus (Location):</Form.Label>
                <Form.Control type="text" name="campus" value={secondUnicampus} onChange={e=> updateFields({secondUnicampus:e.target.value})}/>
                <br /></Form.Group><h4>3rd University Applying For:</h4><Form.Group>
                <Form.Control type="text" name="university-preference-3" value={universityPreferenceThree} onChange={e=> updateFields({universityPreferenceThree:e.target.value})}/>
            </Form.Group><h4>Programmes Applying</h4><Form.Text>
                Choose up to three courses you would like to study and list them in order of preference. Check the entry
                requirements and prerequisite subjects for each to see if you qualify. If you meet the requirements of your
                first choice, you will not be assessed for your second and third choices.
                ...
                <Form.Label>Preference 1 (Programme Code & Programme Name):</Form.Label>
                <Form.Control type="text" name="3rdUniPprogram-preference-1" value={thirdUniPprogramPreferenceOne} onChange={e=> updateFields({thirdUniPprogramPreferenceOne:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Preference 2 (Programme Code & Programme Name):</Form.Label>
                <Form.Control type="text" name="3rdUniProgram-preference-2" value={thirdUniProgramPreferenceTwo} onChange={e=> updateFields({thirdUniProgramPreferenceTwo:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Preference 3 (Programme Code & Programme Name):</Form.Label>
                <Form.Control type="text" name="3rdUniProgram-preference-3" value={ thirdUniProgramPreferenceThree} onChange={e=> updateFields({thirdUniProgramPreferenceThree:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Intake:</Form.Label>
                <Form.Control type="text" name="intake" value={ thirdUniintake} onChange={e=> updateFields({thirdUniintake:e.target.value})}/>
            </Form.Group><Form.Group>
                <Form.Label>Campus (Location):</Form.Label>
                <Form.Control type="text" name="campus" value={ thirdUnicampus} onChange={e=> updateFields({thirdUnicampus:e.target.value})}/>
            <br /><br /><hr />
                ...
                <Form.Label>Other names:<span style={{color:"red"}}>*</span></Form.Label>
                ...
                <Form.Label>Do you have a disability?<span style={{color:"red"}}>*</span></Form.Label>
                <div>
                ...
                <Form.Label>Are you an Australian permanent resident?<span style={{color:"red"}}>*</span></Form.Label>
                <div>
                ...
                <Form.Label>Have you ever been excluded from an Australian education institution before?<span style={{color:"red"}}>*</span></Form.Label>
                <div>
